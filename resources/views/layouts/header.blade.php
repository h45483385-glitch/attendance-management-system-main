    ...
    <div class="topbar-left">
        <a href="/" class="logo text-center d-flex align-items-center justify-content-center" style="height: 100%; text-decoration: none;">
            <span class="logo-large">
                <h3 style="font-weight: 700; margin: 0; font-size: 18px; letter-spacing: 0.5px;">
                    <span style="color: #ffffff;">PRAGNAWARE</span> <span style="color: var(--primary-green);">SOLUTIONS</span>
                </h3>
            </span>
            <span class="logo-small">
                <img src="{{ asset('assets/images/PG.png') }}" alt="logo" height="32" class="rounded-circle" onerror="this.src='https://ui-avatars.com/api/?name=P&background=22c55e&color=fff';">
            </span>
        </a>
    </div>
